...
urlpatterns = [
    ...
    #USERPACKETS
    path('user_packets/create/<int:packet_id>', views.CreateUserPackets.as_view(), name='user_packet_create'),
    path('user_packets/delete/<int:packet_id>', views.DeleteUserPackets.as_view(), name='delete_user_packet'),
